      ...
      items={[
        {
          ...
          imageSrc: '/community-access.jpg',
          imageAlt: 'Food Access',
        },
        {
          ...
          imageSrc: '/community-stability.jpg',
          imageAlt: 'Housing Stability',
        },
        {
          title: 'Local Action',
          ...
          imageSrc: '/community-action.jpg',
          imageAlt: 'Local Action',
        },
      ]}
      onClose={onClose}
    />
